...
class _InputWidgetState extends State<InputWidget> {
  ...
  _inputLingkaran() => FormBuilderTextField(
        ...
        decoration: const InputDecoration(hintText: 'Masukkan jari-jari'),
        validator: (value) {
    ...
    return Column(
      children: [
        FormBuilderTextField(
          ...
          keyboardType: TextInputType.number,
          textAlign: TextAlign.center,
          decoration: const InputDecoration(hintText: 'Masukkan sisi'),
          validator: (value) {
            String input = value ?? '0';
            if (input.isEmpty) {
              return 'Tidak boleh kosong';
        ...
        FormBuilderTextField(
          ...
          keyboardType: TextInputType.number,
          textAlign: TextAlign.center,
          decoration: const InputDecoration(hintText: 'Masukkan sisi2'),
          validator: (value) {
            String input = value ?? '0';
            if (input.isEmpty) {
              return 'Tidak boleh kosong';
        ...
        FormBuilderTextField(
          ...
          keyboardType: TextInputType.number,
          textAlign: TextAlign.center,
          decoration: const InputDecoration(hintText: 'Masukkan diagonal1'),
          validator: (value) {
            String input = value ?? '0';
            if (input.isEmpty) {
              return 'Tidak boleh kosong';
        ...
        FormBuilderTextField(
          ...
          keyboardType: TextInputType.number,
          textAlign: TextAlign.center,
          decoration: const InputDecoration(hintText: 'Masukkan diagonal2'),
          validator: (value) {
            String input = value ?? '0';
            if (input.isEmpty) {
              return 'Tidak boleh kosong';
  ...
  _inputTrapesium() => Column(
        children: [
          ...
          FormBuilderTextField(
            ...
            keyboardType: TextInputType.number,
            textAlign: TextAlign.center,
            decoration: const InputDecoration(hintText: 'Masukkan sisi3'),
            validator: (value) {
              String input = value ?? '0';
              if (input.isEmpty) {
                return 'Tidak boleh kosong';
          ...
          FormBuilderTextField(
            ...
            keyboardType: TextInputType.number,
            textAlign: TextAlign.center,
            decoration: const InputDecoration(hintText: 'Masukkan sisi4'),
            validator: (value) {
              String input = value ?? '0';
              if (input.isEmpty) {
                return 'Tidak boleh kosong';
          ...
          FormBuilderTextField(
            ...
            keyboardType: TextInputType.number,
            textAlign: TextAlign.center,
            decoration: const InputDecoration(hintText: 'Masukkan tinggi'),
            validator: (value) {
              String input = value ?? '0';
              if (input.isEmpty) {
                return 'Tidak boleh kosong';
